...
| `RAG_RELEVANCE_THRESHOLD` | No | `0.4` | Cosine distance cut-off (lower = stricter). If real questions start getting refused too often, print the actual distances ChromaDB returns for a few sample questions and raise this value to match what you see, rather than guessing. |
